...
const MayBayList = () => {
    ...
    // Load danh sách hãng 1 lần duy nhất khi render component
    useEffect(() => {      
    ...
    // Fetch tự động khi filters thay đổi
    const fetchMayBays = useCallback(async () => {
        setLoading(true);
        try {
            const res = await mayBayApi.getDanhSach(filters);
                ...
                <div className="p-4">
                    <div className="mb-4 bg-[#f8f9fc] p-4 rounded border border-gray-200 flex flex-wrap gap-3 items-center">
                        ...
                        <div className="flex flex-1 min-w-[200px]">
                            <input type="text" name="keyword" value={filters.keyword} onChange={handleFilterChange} placeholder="Tìm tên, loại máy bay..." className="w-full text-sm p-2 border border-r-0 border-gray-300 rounded-l focus:outline-none" />
